 ...
 */
            ...
            /**
            *  SetPlaying bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetPlaying
    ...
    public static class Factory{
        ...
        */
        public static SetPlaying parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetPlaying object =
                new SetPlaying();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setPlaying".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetPlaying)geister.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
