 ...
 */
            ...
            /**
            *  GetCognome bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetCognome
    ...
    public static class Factory{
        ...
        */
        public static GetCognome parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetCognome object =
                new GetCognome();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getCognome".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetCognome)geister.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
