 ...
 */
            ...
            /**
            *  GetPartitaID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPartitaID
    ...
    private static class Factory{
        ...
        */
        public static GetPartitaID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPartitaID object =
                new GetPartitaID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPartitaID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPartitaID)data.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
