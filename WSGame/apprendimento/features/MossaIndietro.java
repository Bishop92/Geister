...
/**
 * Feature indicante il numero di volte che il pezzo ha effettuato una mossa indietro
 */
public class MossaIndietro implements Feature {

    private Vector<Integer> pezzi = new Vector<Integer>();

    public MossaIndietro(int numPezzi) {
