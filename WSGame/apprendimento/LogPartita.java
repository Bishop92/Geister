...
public class LogPartita {
	...
	public LogPartita(String  nome_partita){
		try
		{
			...
			res.close(); // chiudere le risorse DB Ë obbligatorio
			cmd.close();
			con.close();
		}
	 ...
	 * del file.
	 * Ogni riga del file corrisponder√† ad un elemento del vettore di output
	 * 
	...
	*/
	...
	public int getLastTurn(){
		...
		int res=0;
		//testo se il turno Ë un numero a singola o doppia (...) cifra
