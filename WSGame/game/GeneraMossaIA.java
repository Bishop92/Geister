...
/**
 * GeneraMossaIA bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class GeneraMossaIA
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public static class Factory {
         ...
         */
        public static GeneraMossaIA parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GeneraMossaIA object =
                    new GeneraMossaIA();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"generaMossaIA".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (GeneraMossaIA) game.ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
