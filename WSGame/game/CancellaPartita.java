 ...
 */
            ...
            /**
            *  CancellaPartita bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CancellaPartita
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":cancellaPartita",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "cancellaPartita",
    ...
    public static class Factory{
        ...
        */
        public static CancellaPartita parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CancellaPartita object =
                new CancellaPartita();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"cancellaPartita".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CancellaPartita)game.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
