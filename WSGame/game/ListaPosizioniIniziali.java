 ...
 */
            ...
            /**
            *  ListaPosizioniIniziali bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListaPosizioniIniziali
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listaPosizioniIniziali",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listaPosizioniIniziali",
    ...
    public static class Factory{
        ...
        */
        public static ListaPosizioniIniziali parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListaPosizioniIniziali object =
                new ListaPosizioniIniziali();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listaPosizioniIniziali".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListaPosizioniIniziali)game.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
