 ...
 */
            ...
            /**
            *  NuovaPosizioneIniziale bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class NuovaPosizioneIniziale
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns2");
                        ...
                        */
                                    ...
                                    protected java.lang.String localPedina ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPedinaTracker = false ;
                        ...
                        */
                                    ...
                                    protected int localPosizione ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPosizioneTracker = false ;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":nuovaPosizioneIniziale",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "nuovaPosizioneIniziale",
                                    ...
                                    writeStartElement(null, namespace, "pedina", xmlWriter);
                                          ...
                                          if (localPedina==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("pedina cannot be null!!");
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localIdtokenTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://game",
                                        ...
                                        if (localPedina != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPedina));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("pedina cannot be null!!");
                                        }
                                    } if (localPosizioneTracker){
    ...
    public static class Factory{
        ...
        */
        public static NuovaPosizioneIniziale parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            NuovaPosizioneIniziale object =
                new NuovaPosizioneIniziale();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"nuovaPosizioneIniziale".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (NuovaPosizioneIniziale)game.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://game","pedina").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://game","posizione").equals(reader.getName())){
